...
namespace SalesSystem.Sales.Domain.Entities
{
    ...
    {
        public OrderItem(Guid productId, string productName, int quantity, decimal unityPrice)
        {
            ProductId = productId;
        ...
        public decimal CalculatePrice() => Quantity * UnityPrice;
        ...
        public override void Validate()
        {
            ...
            AssertionConcern.EnsureGreaterThan(UnityPrice, 0, "The unit price must be greater than zero.");
        }
    }
}
